...
Here we have a significant effect on "people". Estos resultados se usaron para el ms.


Let's use the disturbance index2 instead (se usó index2 en el manuscrito):
